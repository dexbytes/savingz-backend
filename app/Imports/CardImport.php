...
class CardImport implements ToModel,SkipsEmptyRows, WithHeadingRow, WithValidation,SkipsOnError,SkipsOnFailure,WithEvents
{
    ...
    */
    ...
    {
        return CardSummaryHeader::HEADER;
    }
