                ...
                <div class="card-body">
                    <form wire:submit.prevent='update' class='d-flex flex-column align-items-center' enctype="multipart/form-data">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input wire:model.lazy="user.name" type="name" class="form-control border border-2 p-2"
                        ...
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <input type="name" name='user.email' class="form-control border border-2 p-2"
                                id="exampleInputemail" placeholder="Enter name" wire:model.lazy="user.email">
                                @error('user.email')
                                <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                        </div>
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <select class="form-select border border-2 p-2" wire:model="user.role_id"
                        ...
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <input wire:model.lazy="password" type="password" class="form-control border border-2 p-2"
                        ...
                        <div class="form-group col-12 col-md-6 mt-3">
                            ...
                            <input wire:model.lazy="confirmPassword" type="password" class="form-control border border-2 p-2"
