                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            ...
                            <a class="btn bg-gradient-dark mb-0 me-4" href="{{ route('add-card') }}"><i
                                    class="material-icons text-sm">add</i>&nbsp;&nbsp;Add Card</a>
            ...
            @if (Session::has('status'))
                ...
                <x-table>
                    ...
                    <x-slot name="head">
                        ...
                        <x-table.heading sortable wire:click="sortBy('expiration_year')"
                        :direction="$sortField === 'expiration_year' ? $sortDirection : null"> Expiry On
                        </x-table.heading>

                        <x-table.heading sortable wire:click="sortBy('card_holder_name')"
                        :direction="$sortField === 'card_holder_name' ? $sortDirection : null">Card Holder Name
                        </x-table.heading>
                        
                        <x-table.heading> Assigned
                        </x-table.heading>   
                    ...
                    @foreach ($cards as  $card)
                        <x-table.row wire:key="row-{{$card->id }}">
                            ...
                            <x-table.cell>{{ $card->created_at->format(config('app_settings.date_format.value')) }}</x-table.cell>
                            <x-table.cell>                                 
                               <div class="dropdown dropup dropleft">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li><a class="dropdown-item"  data-original-title="Edit" title="Edit" href="{{ route('edit-card', $card) }}">Edit</a></li>
                                       <li><a class="dropdown-item text-danger"  data-original-title="Remove" title="Remove" wire:click="destroyConfirm({{ $card->id }})">Delete</a></li>
                                    </ul>
                                </div>                           
                            </x-table.cell>
                        </x-table.row>
