                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <div class="input-group input-group-static">
                                            <label>Name *</label>
                                            <input wire:model.lazy="serviceCategory.name" class="multisteps-form__input form-control" type="text" placeholder="Enter a Service Category name" />
                                        </div>
                                        @error('serviceCategory.name')
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="input-group input-group-static">
                                            <div class="form-check form-switch ms-3">
                                                <label>Status</label>
                                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault35" wire:model="serviceCategory.status">
                                            </div>
                                            @error('serviceCategory.status')
                                            <p class='text-danger inputerror'>{{ $message }} </p>
                                            @enderror
                                        </div>
                                    </div>
