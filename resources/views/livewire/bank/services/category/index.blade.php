                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            ...
                            <a class="btn bg-gradient-dark mb-0 me-4" href="{{ route('add-service-category') }}"><i
                                    class="material-icons text-sm">add</i>&nbsp;&nbsp;Add Service Category</a>
